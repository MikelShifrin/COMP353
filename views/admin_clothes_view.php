...
<html>
    ...
    <body>
		...
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h1 class="display-3">Clothes View</h1>
				<p class="lead"></p>
			</div>
		</div>
		...
		<?php
			function fillTable(){
				...
				$queryGetClothes = "SELECT Clothes.price,Clothes.rating,Clothes.descr,Clothes.title,Clothes.type,Clothes.date,Clothes.cType,Clothes.cID,Ad.cID as Ad,Ad.userID,Ad.startDate,Ad.endDate,User.email FROM (Clothes INNER JOIN Ad ON Clothes.cID=Ad.cID) INNER JOIN User ON Ad.userID=User.uID";

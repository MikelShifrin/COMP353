    ...
    private function registerNewUser()
    {
        if (empty($_POST['user_password_new']) || empty($_POST['user_password_repeat'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $user_credit_card = $this->db_connection->real_escape_string(strip_tags($_POST['user_credit_card'], ENT_QUOTES));
                $membership = $this->db_connection->real_escape_string(strip_tags($_POST['user_membership'], ENT_QUOTES));
                ...
                if ($query_check_user_name->num_rows == 1) {
                    ...
                    $sql = "INSERT INTO User
                            VALUES('" . uniqid() . "', '" . $user_fname . "', '" . $user_lname . "', '" . $user_password_hash . "', '" . $user_email . "',  '" . False . "', '" . $user_phone . "', '" . $user_credit_card . "','" . $membership . "');";
                    echo ($sql);
